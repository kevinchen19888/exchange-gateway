 ...
 *
 *
 * get order arrar :[[49373525810,null,1597803091414,"tBTCUSD",1597803091414,1597803091416,-0.0007,-0.0007,"EXCHANGE LIMIT",null,null,null,0,
 * "ACTIVE",null,null,12500,0,0,0,null,null,null,0,0,null,null,null,"API>BFX",null,null,{"aff_code":"AFF_CODE_HERE"}]]
 */
@Data
@JsonFormat(shape = JsonFormat.Shape.ARRAY)
@JsonInclude(JsonInclude.Include.NON_NULL)

public class BitfinexSubmitOrderDetail {
    private Long id;
    private Object gid;
    private Long cid;
    ...
    @JsonCreator
    public BitfinexSubmitOrderDetail(
