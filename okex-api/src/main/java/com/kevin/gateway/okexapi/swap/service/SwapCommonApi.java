...
public interface SwapCommonApi {
     ...
     * @return 合约信息列表
     */
    CommonSwapContractInfo []getContractInfo();
     ...
     * @return 深度数据
     */
    SwapDepthInfoResponse getSwapDepth(SwapMarketId instrumentId, Integer size, BigDecimal depth);
     ...
     * @return 全部ticker信息
     */
    SwapTickerResponse[] getAllTicker();
     ...
     * @return 某个ticker信息
     */
    SwapTickerResponse getTickerByInstrumentId(SwapMarketId instrumentId);
     ...
     */
    SwapNewDealResponse[] getSwapNewDeal(SwapMarketId instrumentId, Long after, Long before, Integer limit);
    ...
    FutureKLineResponse[] getCandles(SwapMarketId instrumentId, LocalDateTime start, LocalDateTime end, CandleInterval granularity);
     ...
     * @return 获取币种指数
     */
    SwapIndexResponse getSwapIndex(SwapMarketId instrumentId);
     ...
     * @return 合约整个平台的总持仓量
     */
    SwapPlatformHoldsResponse getPlatformHolds(SwapMarketId instrumentId);
     ...
     */
    SwapPriceLimitResponse getSwapPriceLimit(SwapMarketId instrumentId);
     ...
     * @return 合约标记价格
     */
    SwapMarkPriceResponse getSwapMarkPrice(SwapMarketId instrumentId);
     ...
     * @return
     */
    SwapCapitalRateResponse getSwapCapitalRate(SwapMarketId instrumentId);
     ...
     * @return
     */
    SwapHistoryCapitalRateResponse[] getSwapHistoryCapitalRate(SwapMarketId instrumentId, Integer limit);
     ...
     * @return 获取合约强平单
     */
    SwapLiquidationOrderResponse[] getLiquidationOrders(SwapMarketId instrumentId, Integer status, Integer from, Integer to, Integer limit);
     ...
     * @return 合约的历史K线数据
     */
    HistoryKLineResponse[] getHistoryKlines(SwapMarketId instrumentId, LocalDateTime start, LocalDateTime end, CandleInterval granularity, Integer limit);
}
