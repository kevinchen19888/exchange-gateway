...
import com.kevin.gateway.huobiapi.spot.model.ApiTrading;
import com.kevin.gateway.huobiapi.spot.model.SpotSymbolsState;
 ...
 */
@Data
public class SpotSymbolsVo {

    private SpotSymbolsState state;//交易对状态
